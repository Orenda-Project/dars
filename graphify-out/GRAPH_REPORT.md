...
## Corpus Check
- 128 files · ~124,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1156 nodes · 3670 edges · 73 communities detected
...
Cohesion: 0.07
Nodes (151): Base, Base, DeclarativeBase, AcademicYear, AssessmentSlot, Book, BookChapter, ChapterPlan (+143 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (102): BaseModel, Teacher, add_assessment_slot(), add_holiday(), assign_subject(), auto_schedule_assessments(), breakdown_year(), bulk_upsert_chapter_plans() (+94 more)
...
Cohesion: 0.04
Nodes (64): client(), get_current_client(), create_client_endpoint(), list_clients_endpoint(), rotate_my_key(), RotateKeyResponse, update_client_endpoint(), ClientAdminResponse (+56 more)
...
- **Thin community `Community 30`** (5 nodes): `BaseSettings`, `cors_origins_list()`, `effective_core_db_url()`, `Settings`, `config.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (4 nodes): `get_db()`, `database.py`, `test_database.py`, `test_db_session_yields_async_session()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `EG Integration`, `UG_EG Exam Generation Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (2 nodes): `Documentation Types & Line Limits`, `YAML Frontmatter Convention`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Return CORE_DB_URL if set, otherwise build it from the 5-part env vars.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `Return canonical subject code, raise ValueError if unrecognised.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Return canonical curriculum code, raise ValueError if unrecognised.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `Return canonical grade integer, raise ValueError if out of range.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `Raise ValueError if subject is not valid for the given curriculum.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `Create a PENDING lesson plan record and return it. Background task fires separat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `Create a PENDING exam generation record and return it. Background task fires sep`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `Fetch a single exam generation, always filtering by client_id.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `Return (items, total) for paginated exam generation list, always filtered by cli`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `Background task: call EG Assistant, update ExamGeneration record, fire webhook.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `Extract a JSON array from LLM response using two fallback strategies.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `Split MCQs into questions-only and answers-only parallel lists.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `Background task: generate MCQs from a lesson plan and update the assessment reco`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `Fetch a single custom lesson plan, always filtering by client_id.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `Return (items, total) for paginated custom lesson plan list, filtered by client_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (1 nodes): `Background task: call LP Assistant, update CustomLessonPlan record.     Uses its`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `Background task: submit to UG_EG v2 async endpoint, poll for result, update reco`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `Extract a JSON array from LLM response using two fallback strategies.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `Split MCQs into questions-only and answers-only parallel lists.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `Background task: generate student MCQs from a lesson plan and update the student`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (1 nodes): `Return CORE_DB_URL if set, otherwise build it from the 5-part env vars.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (1 nodes): `Beads Work Tracking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `Structured Logging Convention`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `Next.js Agent Rules (AGENTS.md)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `Webhook DLQ UI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Daily Make Commands`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `Supabase Environments (dars-dev, dars-prod)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `API Key Format (dars_ prefix)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `Migration File Rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `metadata_ Field Naming Smell`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `Cursor-Based Pagination (missing)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `LP Deletion Endpoint (missing)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `Rate Limiting (missing)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `API Authentication (X-API-Key)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `Analytics API (GET /api/v1/analytics)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `external_id Concept`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `Exam Generation Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `Digital Coach Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 1`, `Community 2`, `Community 35`, `Community 8`, `Community 12`, `Community 24`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Client` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 12`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `Book` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 10`, `Community 15`, `Community 18`?**
...
- **Are the 80 inferred relationships involving `Book` (e.g. with `Base` and `CreateTopicRequest`) actually correct?**
