...
**As of 2026-06-02 — ✅ FEATURE CLOSED. All 3 phases shipped + verified, all deploys green.**
...
| Phase 3 — teacher Chapter Plan | F3.1 syllabus-by-today · F3.2 slot-count · F3.3 generate · F3.4 UI · F3.5 periods | ✅ shipped PR #104; server+webapp green; migration 20260605000000 (book_chapter_id) live; D-16; Phase-2 regressions fixed. |
