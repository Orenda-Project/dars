...
|----------|----------------|
| [ROADMAP.md](ROADMAP.md) | Current phase, what's done, what's next |
| [conventions.md](conventions.md) | Code conventions and gotchas |
...
| [personal/](personal/) | Personal notes and cheat sheets |
