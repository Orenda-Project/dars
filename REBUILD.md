...
| Phase 2 (Breakdown Engine) | 🟡 bead `feat-v2-phase-2-breakdown` open; F2.1 ✅ shipped; F2.2 in flight (PR pending) |
...
F2.2 PR pending review/merge to `staging`. Once merged, proceed with F2.3 (port remaining Schema prompts: math/urdu SLO breakdown, chapter_plan, lp_tagging) per [docs/plans/2026-05-15-dars-v2-rebuild/04-phase-2-breakdown-engine.md](docs/plans/2026-05-15-dars-v2-rebuild/04-phase-2-breakdown-engine.md). Branch off `staging`. One PR per feature.
